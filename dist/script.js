...
/***/ "./src/js/constants/consts.js":
/*!************************************!*\
  !*** ./src/js/constants/consts.js ***!
  \************************************/
/*! exports provided: input, letters, specs, textExample, symbolsPerMinute, errorPercent, party */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "textExample", function() { return textExample; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "symbolsPerMinute", function() { return symbolsPerMinute; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "errorPercent", function() { return errorPercent; });
...
/* harmony import */ var _modules_create__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modules/create */ "./src/js/modules/create.js");



var input = document.querySelector('input');
var letters = Array.from(document.querySelectorAll('[data-letters]'));
var specs = Array.from(document.querySelectorAll('[data-spec]'));
var textExample = document.querySelector('#textExample');
var symbolsPerMinute = document.querySelector('#symbolsPerMinute');
var errorPercent = document.querySelector('#errorPercent');
var party = Object(_modules_create__WEBPACK_IMPORTED_MODULE_2__["createParty"])(localStorage.getItem('text'));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_init__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/init */ "./src/js/modules/init.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_services_request__WEBPACK_IMPORTED_MODULE_1__["getText"])('https://fish-text.ru/get').then(function (responce) {
    return localStorage.setItem('text', responce.text);
  });
  Object(_modules_init__WEBPACK_IMPORTED_MODULE_0__["init"])();
});
...
/*!**********************************!*\
  !*** ./src/js/modules/create.js ***!
  \**********************************/
/*! exports provided: createParty */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createParty", function() { return createParty; });
...
function createParty(text) {
  ...
  var words = party.text.split(' '); // из слов делаем строки и пушим их в массив party.strings
  ...
  try {
    for (var _iterator = words[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      var newStringLength = [].concat(_toConsumableArray(string), [word]).join(' ').length + !word.includes('\n');
...
var getText = function getText(url) {
  var res;
